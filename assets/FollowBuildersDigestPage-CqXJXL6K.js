import{V as e,Y as t,k as n}from"./icons-BUPYIIHA.js";import{n as r}from"./ui-BSeCcvEH.js";import{i,n as a,u as o}from"./router-DosSoxt8.js";import{c as s,d as c,v as l}from"./Seo-DKGuJ-rk.js";import{l as u}from"./index-CdEXQ4uH.js";import{t as d}from"./BlogMarkdown-DOIukXmG.js";var f=`---
...
Generated through the Follow Builders skill: https://github.com/zarazhangrui/follow-builders
`,F=r(),I=Object.entries(Object.assign({"../../../data/follow-builders/digests/2026-09-04.md":f,"../../../data/follow-builders/digests/2026-09-05.md":p,"../../../data/follow-builders/digests/2026-09-06.md":m,"../../../data/follow-builders/digests/2026-09-07.md":h,"../../../data/follow-builders/digests/2026-09-08.md":g,"../../../data/follow-builders/digests/2026-09-09.md":_,"../../../data/follow-builders/digests/2026-09-10.md":v,"../../../data/follow-builders/digests/2026-09-11.md":y,"../../../data/follow-builders/digests/2026-09-12.md":b,"../../../data/follow-builders/digests/2026-09-13.md":x,"../../../data/follow-builders/digests/2026-09-14.md":S,"../../../data/follow-builders/digests/2026-09-15.md":C,"../../../data/follow-builders/digests/2026-09-16.md":w,"../../../data/follow-builders/digests/2026-09-17.md":T,"../../../data/follow-builders/digests/2026-09-18.md":E,"../../../data/follow-builders/digests/2026-09-19.md":D,"../../../data/follow-builders/digests/2026-09-20.md":O,"../../../data/follow-builders/digests/2026-09-21.md":k,"../../../data/follow-builders/digests/2026-09-22.md":A,"../../../data/follow-builders/digests/2026-09-23.md":j,"../../../data/follow-builders/digests/2026-09-24.md":M,"../../../data/follow-builders/digests/2026-09-25.md":N,"../../../data/follow-builders/digests/2026-09-26.md":P})).map(([e,t])=>{let n=e.match(/\/([0-9]{4}-[0-9]{2}-[0-9]{2})\.md$/);if(!n)return null;let{meta:r,body:i}=l(t);return{...r,body:i,slug:n[1]}}).filter(e=>e!==null).sort((e,t)=>t.date.localeCompare(e.date));function L(){let{date:r}=o(),{locale:l}=c(),f=l===`en`,p=f?`AI Builders Daily Digest`:`AI Builders 每日摘要`,m=f?`A daily, source-linked digest of what leading AI builders are researching, shipping, and debating.`:`每天整理 AI 研究者、创始人、产品经理和工程师正在研究、发布与讨论的内容，并保留原始来源链接。`;if(r){let e=I.find(e=>e.slug===r);return e?(0,F.jsxs)(u,{path:`/docs/guides/ai-builders-digest/${e.slug}/`,title:e.title,description:e.description||m,children:[(0,F.jsx)(`div`,{className:`not-prose mb-6`,children:(0,F.jsxs)(a,{to:s(`/docs/guides/ai-builders-digest/`,l),className:`inline-flex items-center gap-1.5 text-xs font-medium text-violet-300 transition-colors hover:text-violet-200`,children:[(0,F.jsx)(t,{className:`h-3.5 w-3.5`}),f?`Back to digest archive`:`返回摘要归档`]})}),(0,F.jsx)(d,{markdown:e.body})]}):(0,F.jsx)(i,{to:s(`/docs/guides/ai-builders-digest/`,l),replace:!0})}return(0,F.jsxs)(u,{path:`/docs/guides/ai-builders-digest/`,title:p,description:m,headings:[{id:`how-to-read`,text:f?`How to read`:`阅读方式`,level:2},{id:`digest-archive`,text:f?`Digest archive`:`每日摘要`,level:2}],children:[(0,F.jsxs)(`section`,{className:`not-prose mb-10 rounded-lg border border-violet-500/20 bg-violet-500/[0.05] p-5`,children:[(0,F.jsxs)(`div`,{className:`flex items-center gap-2 text-sm font-medium text-violet-200`,children:[(0,F.jsx)(n,{className:`h-4 w-4`}),f?`Published from the Follow Builders skill`:`由 Follow Builders Skill 自动整理发布`]}),(0,F.jsx)(`p`,{className:`mt-2 text-sm leading-6 text-ink-300`,children:f?`Each entry is generated from the project feed, keeps a direct link to every included item, and is mirrored to the connected Obsidian vault.`:`每一期内容来自项目 feed，所有纳入的内容都保留直接来源链接，并同步写入已连接的 Obsidian vault。`})]}),(0,F.jsx)(`h2`,{id:`how-to-read`,children:f?`How to read`:`阅读方式`}),(0,F.jsx)(`p`,{children:f?`Start with the newest entry. The bottom line is the short operational takeaway; the bullets preserve the specific ideas worth following up. Treat each item as a pointer to the original source, not as a replacement for it.`:`优先阅读最新一期。“一句话结论”用于快速判断是否值得继续看，下面的要点保留值得跟进的具体观点。每一条都指向原始来源，摘要不替代原文。`}),(0,F.jsx)(`h2`,{id:`digest-archive`,children:f?`Digest archive`:`每日摘要`}),I.length?(0,F.jsx)(`div`,{className:`not-prose space-y-3`,children:I.map(t=>(0,F.jsxs)(a,{to:s(`/docs/guides/ai-builders-digest/${t.slug}/`,l),className:`group flex items-center justify-between gap-4 rounded-lg border border-white/5 bg-white/[0.02] px-4 py-4 transition-colors hover:border-violet-500/40 hover:bg-violet-500/[0.05]`,children:[(0,F.jsxs)(`span`,{className:`min-w-0`,children:[(0,F.jsx)(`span`,{className:`block truncate text-base font-medium text-ink-100 group-hover:text-violet-200`,children:t.title}),(0,F.jsx)(`span`,{className:`mt-1 block text-xs text-ink-400`,children:t.description||(f?`Source-linked daily digest.`:`保留原始来源链接的每日摘要。`)})]}),(0,F.jsxs)(`span`,{className:`inline-flex shrink-0 items-center gap-1.5 text-xs text-ink-400`,children:[(0,F.jsx)(e,{className:`h-3.5 w-3.5`}),t.date]})]},t.slug))}):(0,F.jsx)(`div`,{className:`not-prose rounded-lg border border-white/5 p-6 text-sm text-ink-400`,children:f?`The first digest has not been published yet.`:`首期摘要尚未发布。`})]})}export{L as default};