import{n as e}from"./ui-BSeCcvEH.js";import{n as t}from"./router-DosSoxt8.js";import{d as n,s as r}from"./Seo-DKGuJ-rk.js";import{t as i}from"./CodeBlock-AiaDnPq3.js";import{a,c as o,i as s,l as c,o as l,s as u}from"./index-CdEXQ4uH.js";var d=e(),f=[{name:`id`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`Model ID, such as `,(0,d.jsx)(`code`,{children:`grok-image-video`}),`.`]})},{name:`object`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`Always `,(0,d.jsx)(`code`,{children:`model`}),`.`]})},{name:`capabilities`,type:`string[]`,description:(0,d.jsxs)(d.Fragment,{children:[`Supported capabilities such as `,(0,d.jsx)(`code`,{children:`video`}),`, `,(0,d.jsx)(`code`,{children:`image`}),`, and `,(0,d.jsx)(`code`,{children:`streaming`}),`.`]})},{name:`modalities`,type:`string[]`,description:(0,d.jsxs)(d.Fragment,{children:[`Supported modalities, including `,(0,d.jsx)(`code`,{children:`video`}),` and `,(0,d.jsx)(`code`,{children:`image`}),`.`]})}],p=[{name:`model`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`Use `,(0,d.jsx)(`code`,{children:`grok-image-video`}),` or another ID returned by the model list.`]})},{name:`prompt`,type:`string`,required:!0,description:(0,d.jsx)(d.Fragment,{children:`The video generation prompt.`})},{name:`seconds`,type:`integer`,description:(0,d.jsx)(d.Fragment,{children:`Suggested values are 4, 6, 8, 10, 12, or 15 depending on the model and input images.`})},{name:`aspect_ratio`,type:`string`,description:(0,d.jsxs)(d.Fragment,{children:[`For example `,(0,d.jsx)(`code`,{children:`16:9`}),` or `,(0,d.jsx)(`code`,{children:`9:16`}),`.`]})},{name:`resolution`,type:`string`,description:(0,d.jsxs)(d.Fragment,{children:[`Common values are `,(0,d.jsx)(`code`,{children:`720p`}),` and `,(0,d.jsx)(`code`,{children:`480p`}),`.`]})},{name:`image_urls`,type:`array<string>`,description:(0,d.jsx)(d.Fragment,{children:`Public HTTPS image URLs or complete base64 data URLs.`})},{name:`input_reference`,type:`object | string`,description:(0,d.jsx)(d.Fragment,{children:`Single-reference compatibility field. Do not combine it with another image field.`})},{name:`reference_images`,type:`array<string>`,description:(0,d.jsxs)(d.Fragment,{children:[`Multi-reference compatibility field. Do not combine it with `,(0,d.jsx)(`code`,{children:`input_reference`}),`.`]})}],m=`curl -X POST "https://img.gpt88.cc/v1/videos/generations" \\
  ...
  -d '{
    ...
    "aspect_ratio": "16:9",
    "resolution": "720p"
  }'`,h=`curl "https://img.gpt88.cc/v1/videos/<VIDEO_ID>" \\
  -H "Authorization: Bearer $GPT88_API_KEY"`,g=`curl "https://img.gpt88.cc/v1/videos/<VIDEO_ID>/content" \\
  -H "Authorization: Bearer $GPT88_API_KEY" \\
  -o generated-video.mp4`;function _(){let e=u({locale:`en`,surface:`api_grok_video_auth`,intent:`image_api`,destination:`keys`});return(0,d.jsxs)(c,{path:`/docs/api/grok-video/`,title:`Grok Video API`,description:`Integrate asynchronous Grok video generation with model discovery, task creation, polling, content download, image references, and JavaScript-ready request patterns.`,headings:[{id:`overview`,text:`Overview`,level:2},{id:`auth`,text:`Authentication`,level:2},{id:`models`,text:`List available models`,level:2},{id:`create`,text:`Create a video task`,level:2},{id:`poll`,text:`Poll task status`,level:2},{id:`download`,text:`Download the video`,level:2},{id:`errors`,text:`Common errors`,level:2}],children:[(0,d.jsx)(o,{tone:`info`,title:`The workflow is asynchronous`,children:(0,d.jsx)(`p`,{children:`Submit a task, persist its returned ID, poll until it is completed or failed, then download the video bytes.`})}),(0,d.jsx)(`h2`,{id:`overview`,children:`Overview`}),(0,d.jsx)(s,{method:`GET`,path:`https://img.gpt88.cc/v1/models`}),(0,d.jsx)(s,{method:`POST`,path:`https://img.gpt88.cc/v1/videos/generations`}),(0,d.jsx)(s,{method:`GET`,path:`https://img.gpt88.cc/v1/videos/{id}`}),(0,d.jsx)(s,{method:`GET`,path:`https://img.gpt88.cc/v1/videos/{id}/content`}),(0,d.jsx)(l,{rows:[{name:`Base URL`,type:`string`,required:!0,description:(0,d.jsx)(`code`,{children:`https://img.gpt88.cc`})},{name:`Authentication`,type:`header`,required:!0,description:(0,d.jsx)(`code`,{children:`Authorization: Bearer <YOUR_API_KEY>`})},{name:`Request format`,type:`string`,required:!0,description:(0,d.jsx)(`code`,{children:`application/json`})},{name:`Task type`,type:`async`,required:!0,description:(0,d.jsx)(d.Fragment,{children:`The create endpoint returns a task object before the final video is ready.`})}]}),(0,d.jsx)(`h2`,{id:`auth`,children:`Authentication`}),(0,d.jsxs)(`p`,{children:[`Create or copy an API key in `,(0,d.jsx)(`a`,{href:e,target:`_blank`,rel:`noreferrer`,children:`Agent API Keys`}),` and send it as a Bearer token. Keep the key on your backend; do not expose it in a browser bundle or mobile app.`]}),(0,d.jsx)(i,{lang:`bash`,filename:`auth-header.txt`,code:`Authorization: Bearer <YOUR_API_KEY>`}),(0,d.jsx)(`h2`,{id:`models`,children:`List available models`}),(0,d.jsx)(i,{lang:`bash`,filename:`list-models.sh`,code:`curl -H "Authorization: Bearer $GPT88_API_KEY" https://img.gpt88.cc/v1/models`}),(0,d.jsx)(l,{rows:f}),(0,d.jsxs)(`p`,{children:[`Use the live model response instead of hard-coding a model list. The examples below use `,(0,d.jsx)(`code`,{children:`grok-image-video`}),`.`]}),(0,d.jsx)(`h2`,{id:`create`,children:`Create a video task`}),(0,d.jsx)(l,{rows:p}),(0,d.jsx)(i,{lang:`bash`,filename:`create-video.sh`,code:m}),(0,d.jsx)(o,{tone:`warn`,title:`Reference-image constraints`,children:(0,d.jsxs)(`ul`,{children:[(0,d.jsxs)(`li`,{children:[(0,d.jsx)(`code`,{children:`grok-video-1.5`}),` accepts exactly one reference image and is intended for single-image video.`]}),(0,d.jsxs)(`li`,{children:[(0,d.jsx)(`code`,{children:`grok-image-video`}),` accepts text-to-video, single-reference, and multi-reference workflows.`]}),(0,d.jsxs)(`li`,{children:[`Do not send `,(0,d.jsx)(`code`,{children:`image_urls`}),`, `,(0,d.jsx)(`code`,{children:`images`}),`, `,(0,d.jsx)(`code`,{children:`input_reference`}),`, and `,(0,d.jsx)(`code`,{children:`reference_images`}),` together.`]})]})}),(0,d.jsx)(`h2`,{id:`poll`,children:`Poll task status`}),(0,d.jsxs)(`p`,{children:[`Save `,(0,d.jsx)(`code`,{children:`id`}),` first. For compatibility with older responses, also accept `,(0,d.jsx)(`code`,{children:`request_id`}),` or `,(0,d.jsx)(`code`,{children:`task_id`}),` when selecting the ID. Poll every five seconds for up to five minutes, and do not submit a duplicate generation task while the original is running.`]}),(0,d.jsx)(i,{lang:`bash`,filename:`poll-video.sh`,code:h}),(0,d.jsxs)(`p`,{children:[`Treat `,(0,d.jsx)(`code`,{children:`status: completed`}),` as success. `,(0,d.jsx)(`code`,{children:`failed`}),`, `,(0,d.jsx)(`code`,{children:`cancelled`}),`, and `,(0,d.jsx)(`code`,{children:`expired`}),` are terminal failures. A progress value of 100 does not prove that the task succeeded; always inspect the status field.`]}),(0,d.jsx)(`h2`,{id:`download`,children:`Download the video`}),(0,d.jsx)(`p`,{children:`When the task is completed, request the content endpoint and save the response as binary data.`}),(0,d.jsx)(i,{lang:`bash`,filename:`download-video.sh`,code:g}),(0,d.jsxs)(`p`,{children:[`If a response includes a relative `,(0,d.jsx)(`code`,{children:`url`}),` or `,(0,d.jsx)(`code`,{children:`video_url`}),`, resolve it against the image API host. The content endpoint is usually the most stable way to download the final file.`]}),(0,d.jsx)(`h2`,{id:`errors`,children:`Common errors`}),(0,d.jsxs)(`ul`,{children:[(0,d.jsxs)(`li`,{children:[(0,d.jsx)(`strong`,{children:`401:`}),` recopy the API key and check the Bearer header.`]}),(0,d.jsxs)(`li`,{children:[(0,d.jsx)(`strong`,{children:`403:`}),` inspect account permissions, balance, and model availability.`]}),(0,d.jsxs)(`li`,{children:[(0,d.jsx)(`strong`,{children:`400 prompt or model required:`}),` send both fields and copy the exact model ID from `,(0,d.jsx)(t,{to:`/en/docs/api/list-models/`,children:`GET /v1/models`}),`.`]}),(0,d.jsxs)(`li`,{children:[(0,d.jsx)(`strong`,{children:`Reference image fetch failed:`}),` use a directly reachable HTTPS URL or a complete data URL.`]}),(0,d.jsxs)(`li`,{children:[(0,d.jsx)(`strong`,{children:`Timeout:`}),` keep the task ID and continue polling instead of submitting the same generation again.`]}),(0,d.jsxs)(`li`,{children:[(0,d.jsx)(`strong`,{children:`JSON returned from download:`}),` verify the task is completed and that you called `,(0,d.jsx)(`code`,{children:`/v1/videos/<id>/content`}),` with the key.`]})]})]})}var v=[{name:`id`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`模型 ID，例如 `,(0,d.jsx)(`code`,{children:`grok-image-video`}),`。`]})},{name:`object`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`固定为 `,(0,d.jsx)(`code`,{children:`"model"`}),`。`]})},{name:`created`,type:`integer`,description:(0,d.jsx)(d.Fragment,{children:`模型上架时间戳，Unix 秒。`})},{name:`owned_by`,type:`string`,description:(0,d.jsxs)(d.Fragment,{children:[`模型归属 provider，例如 `,(0,d.jsx)(`code`,{children:`xai`}),`。`]})},{name:`capabilities`,type:`string[]`,description:(0,d.jsxs)(d.Fragment,{children:[`支持能力，例如 `,(0,d.jsx)(`code`,{children:`video`}),` / `,(0,d.jsx)(`code`,{children:`image`}),` / `,(0,d.jsx)(`code`,{children:`streaming`}),`。`]})},{name:`modalities`,type:`string[]`,description:(0,d.jsxs)(d.Fragment,{children:[`支持模态，例如 `,(0,d.jsx)(`code`,{children:`video`}),`、`,(0,d.jsx)(`code`,{children:`image`}),`。`]})}],y=[{name:`model`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`模型 ID，例如 `,(0,d.jsx)(`code`,{children:`grok-image-video`}),` 或 `,(0,d.jsx)(`code`,{children:`grok-video-1.5`}),`。`]})},{name:`prompt`,type:`string`,required:!0,description:(0,d.jsx)(d.Fragment,{children:`视频提示词。`})},{name:`seconds`,type:`integer`,description:(0,d.jsxs)(d.Fragment,{children:[`视频秒数，默认建议 `,(0,d.jsx)(`code`,{children:`4`}),`。`]})},{name:`aspect_ratio`,type:`string`,description:(0,d.jsxs)(d.Fragment,{children:[`画幅比例，默认建议 `,(0,d.jsx)(`code`,{children:`16:9`}),`。`]})},{name:`resolution`,type:`string`,description:(0,d.jsxs)(d.Fragment,{children:[`清晰度，建议 `,(0,d.jsx)(`code`,{children:`720p`}),` 或 `,(0,d.jsx)(`code`,{children:`480p`}),`。`]})},{name:`image_urls`,type:`array<string>`,description:(0,d.jsx)(d.Fragment,{children:`参考图 URL 或 base64 data URL 列表。`})},{name:`images`,type:`array<string>`,description:(0,d.jsxs)(d.Fragment,{children:[`兼容字段，含义与 `,(0,d.jsx)(`code`,{children:`image_urls`}),` 相同。不要和 `,(0,d.jsx)(`code`,{children:`image_urls`}),` 同时传。`]})},{name:`input_reference`,type:`object | string`,description:(0,d.jsxs)(d.Fragment,{children:[`单参考图字段，可传 `,(0,d.jsx)(`code`,{children:`{ "image_url": "..." }`}),`。`]})},{name:`reference_images`,type:`array<string>`,description:(0,d.jsxs)(d.Fragment,{children:[`多参考图字段。不要和 `,(0,d.jsx)(`code`,{children:`input_reference`}),` 同时传。`]})}],b=[{name:`id`,type:`string`,required:!0,description:(0,d.jsx)(d.Fragment,{children:`任务唯一 ID。`})},{name:`request_id`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`上游请求 ID。兼容字段；优先保存 `,(0,d.jsx)(`code`,{children:`id`}),` 作为 OpenAI 兼容接口的查询 ID。`]})},{name:`task_id`,type:`string`,description:(0,d.jsx)(d.Fragment,{children:`旧版任务接口可能返回的任务 ID；新格式不一定在顶层返回。`})},{name:`object`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`固定为 `,(0,d.jsx)(`code`,{children:`"video"`}),`。`]})},{name:`model`,type:`string`,required:!0,description:(0,d.jsx)(d.Fragment,{children:`实际使用的模型 ID。`})},{name:`status`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`任务状态，例如 `,(0,d.jsx)(`code`,{children:`queued`}),`。`]})},{name:`progress`,type:`integer | string`,required:!0,description:(0,d.jsx)(d.Fragment,{children:`任务进度，常见为百分比字符串。`})},{name:`created_at`,type:`integer`,description:(0,d.jsx)(d.Fragment,{children:`创建时间戳，Unix 秒。`})}],x=[{name:`id`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`OpenAI 兼容的视频 ID，例如 `,(0,d.jsx)(`code`,{children:`video_gpt88_v1_...`}),`。用于继续查询和下载。`]})},{name:`request_id`,type:`string`,description:(0,d.jsx)(d.Fragment,{children:`上游原始请求 ID。通常不需要自行拼接到 OpenAI 兼容接口中。`})},{name:`object`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`固定为 `,(0,d.jsx)(`code`,{children:`"video"`}),`。`]})},{name:`model`,type:`string`,required:!0,description:(0,d.jsx)(d.Fragment,{children:`实际使用的模型 ID。`})},{name:`status`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`状态为 `,(0,d.jsx)(`code`,{children:`completed`}),` 时表示可获取成品；失败通常为 `,(0,d.jsx)(`code`,{children:`failed`}),`。`]})},{name:`progress`,type:`integer`,description:(0,d.jsxs)(d.Fragment,{children:[`进度百分比，例如 `,(0,d.jsx)(`code`,{children:`100`}),`。`]})},{name:`url`,type:`string`,description:(0,d.jsx)(d.Fragment,{children:`视频内容路径或完整 URL。可能是相对路径。`})},{name:`video_url`,type:`string`,description:(0,d.jsxs)(d.Fragment,{children:[`视频内容路径或完整 URL，与 `,(0,d.jsx)(`code`,{children:`url`}),` 类似。`]})},{name:`video.url`,type:`string`,description:(0,d.jsx)(d.Fragment,{children:`嵌套视频对象中的内容路径。`})},{name:`video.duration`,type:`number`,description:(0,d.jsx)(d.Fragment,{children:`视频时长，单位秒。`})}],S=[{name:`code`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`通常为 `,(0,d.jsx)(`code`,{children:`success`}),`。`]})},{name:`message`,type:`string`,required:!0,description:(0,d.jsx)(d.Fragment,{children:`接口消息。`})},{name:`data.task_id`,type:`string`,required:!0,description:(0,d.jsx)(d.Fragment,{children:`任务 ID。`})},{name:`data.status`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`任务状态：`,(0,d.jsx)(`code`,{children:`SUBMITTED`}),` / `,(0,d.jsx)(`code`,{children:`QUEUED`}),` / `,(0,d.jsx)(`code`,{children:`IN_PROGRESS`}),` / `,(0,d.jsx)(`code`,{children:`NOT_START`}),` / `,(0,d.jsx)(`code`,{children:`SUCCESS`}),` / `,(0,d.jsx)(`code`,{children:`FAILURE`}),`。`]})},{name:`data.progress`,type:`string`,required:!0,description:(0,d.jsxs)(d.Fragment,{children:[`进度字符串，例如 `,(0,d.jsx)(`code`,{children:`30%`}),` 或 `,(0,d.jsx)(`code`,{children:`100%`}),`。`]})},{name:`data.result_url`,type:`string`,description:(0,d.jsx)(d.Fragment,{children:`成功后的临时视频直链。`})},{name:`data.fail_reason`,type:`string`,description:(0,d.jsx)(d.Fragment,{children:`失败原因。`})}],C=String.raw`curl -X GET "https://img.gpt88.cc/v1/models" \
  -H "Authorization: Bearer <YOUR_API_KEY>"`,w=String.raw`curl -X POST "https://img.gpt88.cc/v1/videos/generations" \
  ...
  -d '{
    ...
    "aspect_ratio": "16:9",
    "resolution": "720p"
  }'`,T=String.raw`curl -X POST "https://img.gpt88.cc/v1/videos/generations" \
  -H "Authorization: Bearer <YOUR_API_KEY>" \
  -H "Content-Type: application/json" \
  -d '{
    "model": "grok-image-video",
  ...
  }'`,E=String.raw`curl -X POST "https://img.gpt88.cc/v1/videos/generations" \
  -H "Authorization: Bearer <YOUR_API_KEY>" \
  -H "Content-Type: application/json" \
  -d '{
    "model": "grok-image-video",
  ...
  }'`,D=String.raw`curl -X POST "https://img.gpt88.cc/v1/videos/generations" \
  -H "Authorization: Bearer <YOUR_API_KEY>" \
  -H "Content-Type: application/json" \
  -d '{
...
print("saved generated-video.mp4")`,I=String.raw`import { writeFile } from "node:fs/promises";
