...
const HOME_LABELS: Record<Locale, HomeLabels> = {
  ...
  hi: {
    live: 'लाइव रूटिंग', routeReady: 'गेटवे ऑनलाइन', endpointTitle: 'एक इंटीग्रेशन, दो एंडपॉइंट', endpointBody: 'मानक मॉडल के लिए OpenAI-संगत एंडपॉइंट और इमेज व वीडियो के लिए मीडिया एंडपॉइंट उपयोग करें।',
    standardApi: 'टेक्स्ट, मल्टीमॉडल और मानक API', mediaApi: 'सीधे इमेज और वीडियो कार्य', workflowTitle: 'वास्तविक वर्कफ़्लो के लिए बनाया गया', workflowBody: 'पहले अनुरोध से प्रोडक्शन समस्या-समाधान तक सीधे उपयोगी प्रवेश बिंदु।', modelsTitle: 'मॉडल बदलें, इंटीग्रेशन नहीं', modelsBody: 'एक ही प्रमाणीकरण और अनुरोध प्रारूप के साथ मॉडल कैटलॉग से सही क्षमता चुनें।', reliabilityTitle: 'हर अनुरोध ट्रैक करने योग्य', reliabilityBody: 'स्थिति, रूट, विलंबता और उपयोग एक ही रिकॉर्ड में जुड़े रहते हैं।', requestTrace: 'अनुरोध ट्रेस', startTitle: 'पहला अनुरोध भेजने के लिए तैयार?', startBody: 'API Key बनाएं, एंडपॉइंट कॉपी करें और अपने OpenAI-संगत SDK से कॉल करें।', textModels: 'टेक्स्ट और एजेंट', mediaModels: 'इमेज और वीडियो', routeLabel: 'रूट', latencyLabel: 'विलंबता', statusLabel: 'स्थिति',
  },
  bn: {
    live: 'লাইভ রাউটিং', routeReady: 'গেটওয়ে অনলাইন', endpointTitle: 'একটি ইন্টিগ্রেশন, দুটি এন্ডপয়েন্ট', endpointBody: 'স্ট্যান্ডার্ড মডেলের জন্য OpenAI-সামঞ্জস্যপূর্ণ এন্ডপয়েন্ট এবং ছবি ও ভিডিওর জন্য মিডিয়া এন্ডপয়েন্ট ব্যবহার করুন।', standardApi: 'টেক্সট, মাল্টিমোডাল ও স্ট্যান্ডার্ড API', mediaApi: 'সরাসরি ছবি ও ভিডিও কাজ', workflowTitle: 'বাস্তব ওয়ার্কফ্লোর জন্য তৈরি', workflowBody: 'প্রথম অনুরোধ থেকে প্রোডাকশন সমস্যা সমাধান পর্যন্ত ব্যবহারযোগ্য প্রবেশপথ।', modelsTitle: 'মডেল বদলান, ইন্টিগ্রেশন নয়', modelsBody: 'একই প্রমাণীকরণ ও অনুরোধ কাঠামো রেখে ক্যাটালগ থেকে সঠিক ক্ষমতা বেছে নিন।', reliabilityTitle: 'প্রতিটি অনুরোধ পর্যবেক্ষণযোগ্য', reliabilityBody: 'স্ট্যাটাস, রুট, লেটেন্সি ও ব্যবহার একই রেকর্ডে থাকে।', requestTrace: 'অনুরোধ ট্রেস', startTitle: 'প্রথম অনুরোধ পাঠাতে প্রস্তুত?', startBody: 'API Key তৈরি করুন, এন্ডপয়েন্ট কপি করুন এবং OpenAI-সামঞ্জস্যপূর্ণ SDK ব্যবহার করুন।', textModels: 'টেক্সট ও এজেন্ট', mediaModels: 'ছবি ও ভিডিও', routeLabel: 'রুট', latencyLabel: 'লেটেন্সি', statusLabel: 'স্ট্যাটাস',
  },
  ur: {
    live: 'لائیو روٹنگ', routeReady: 'گیٹ وے آن لائن', endpointTitle: 'ایک انٹیگریشن، دو اینڈ پوائنٹس', endpointBody: 'معیاری ماڈلز کے لیے OpenAI-compatible اینڈ پوائنٹ اور تصاویر و ویڈیو کے لیے میڈیا اینڈ پوائنٹ استعمال کریں۔', standardApi: 'ٹیکسٹ، ملٹی موڈل اور معیاری APIs', mediaApi: 'براہ راست تصاویر اور ویڈیو کے کام', workflowTitle: 'حقیقی ورک فلو کے لیے بنایا گیا', workflowBody: 'پہلی درخواست سے پروڈکشن ٹربل شوٹنگ تک قابلِ استعمال راستے۔', modelsTitle: 'ماڈل بدلیں، انٹیگریشن نہیں', modelsBody: 'ایک ہی تصدیق اور درخواست کے فارمیٹ کے ساتھ کیٹلاگ سے درست صلاحیت منتخب کریں۔', reliabilityTitle: 'ہر درخواست قابلِ نگرانی', reliabilityBody: 'حالت، روٹ، تاخیر اور استعمال ایک ہی ریکارڈ سے منسلک رہتے ہیں۔', requestTrace: 'درخواست ٹریس', startTitle: 'پہلی درخواست بھیجنے کے لیے تیار ہیں؟', startBody: 'API Key بنائیں، اینڈ پوائنٹ کاپی کریں اور موجودہ OpenAI-compatible SDK استعمال کریں۔', textModels: 'ٹیکسٹ اور ایجنٹس', mediaModels: 'تصویر اور ویڈیو', routeLabel: 'روٹ', latencyLabel: 'تاخیر', statusLabel: 'حالت',
  },
  ta: {
    live: 'நேரடி வழித்தடம்', routeReady: 'கேட்வே ஆன்லைனில்', endpointTitle: 'ஒரே ஒருங்கிணைப்பு, இரண்டு எண்ட்பாயிண்ட்கள்', endpointBody: 'நிலையான மாடல்களுக்கு OpenAI-இணக்கமான எண்ட்பாயிண்டையும், படம் மற்றும் வீடியோ பணிகளுக்கு மீடியா எண்ட்பாயிண்டையும் பயன்படுத்தவும்.', standardApi: 'உரை, மல்டிமோடல் மற்றும் நிலையான APIகள்', mediaApi: 'நேரடி படம் மற்றும் வீடியோ பணிகள்', workflowTitle: 'உண்மையான பணிப்பாய்வுகளுக்காக உருவாக்கப்பட்டது', workflowBody: 'முதல் கோரிக்கையிலிருந்து தயாரிப்பு சிக்கல் தீர்வு வரை நேரடி நுழைவுகள்.', modelsTitle: 'மாடலை மாற்றுங்கள், ஒருங்கிணைப்பை அல்ல', modelsBody: 'ஒரே அங்கீகாரம் மற்றும் கோரிக்கை வடிவத்துடன் பட்டியலில் இருந்து திறனைத் தேர்ந்தெடுக்கவும்.', reliabilityTitle: 'ஒவ்வொரு கோரிக்கையும் கண்காணிக்கக்கூடியது', reliabilityBody: 'நிலை, வழித்தடம், தாமதம் மற்றும் பயன்பாடு ஒரே பதிவில் இருக்கும்.', requestTrace: 'கோரிக்கை தடம்', startTitle: 'முதல் கோரிக்கையை அனுப்பத் தயாரா?', startBody: 'API Key உருவாக்கி, எண்ட்பாயிண்டை நகலெடுத்து, OpenAI-இணக்கமான SDK மூலம் அழைக்கவும்.', textModels: 'உரை மற்றும் ஏஜென்ட்கள்', mediaModels: 'படம் மற்றும் வீடியோ', routeLabel: 'வழித்தடம்', latencyLabel: 'தாமதம்', statusLabel: 'நிலை',
  },
  ne: {
    live: 'लाइभ राउटिङ', routeReady: 'गेटवे अनलाइन', endpointTitle: 'एउटा इन्टिग्रेसन, दुई एन्डपोइन्ट', endpointBody: 'मानक मोडेलका लागि OpenAI-compatible एन्डपोइन्ट र तस्वीर तथा भिडियोका लागि मिडिया एन्डपोइन्ट प्रयोग गर्नुहोस्।', standardApi: 'टेक्स्ट, मल्टिमोडल र मानक API', mediaApi: 'प्रत्यक्ष तस्वीर र भिडियो कार्य', workflowTitle: 'वास्तविक वर्कफ्लोका लागि बनाइएको', workflowBody: 'पहिलो अनुरोधदेखि उत्पादन समस्या समाधानसम्म उपयोगी प्रवेशद्वार।', modelsTitle: 'मोडेल बदल्नुहोस्, इन्टिग्रेसन होइन', modelsBody: 'एउटै प्रमाणीकरण र अनुरोध ढाँचासहित क्याटलगबाट सही क्षमता छान्नुहोस्।', reliabilityTitle: 'हरेक अनुरोध ट्र्याक गर्न सकिने', reliabilityBody: 'स्थिति, रुट, विलम्बता र प्रयोग एउटै रेकर्डमा रहन्छ।', requestTrace: 'अनुरोध ट्रेस', startTitle: 'पहिलो अनुरोध पठाउन तयार?', startBody: 'API Key बनाउनुहोस्, एन्डपोइन्ट प्रतिलिपि गर्नुहोस् र OpenAI-compatible SDK प्रयोग गर्नुहोस्।', textModels: 'टेक्स्ट र एजेन्ट', mediaModels: 'तस्वीर र भिडियो', routeLabel: 'रुट', latencyLabel: 'विलम्बता', statusLabel: 'स्थिति',
  },
  si: {
    live: 'සජීවී රවුටින්', routeReady: 'ගේට්වේ සම්බන්ධයි', endpointTitle: 'එක් ඒකාබද්ධ කිරීමක්, එන්ඩ්පොයින්ට් දෙකක්', endpointBody: 'සම්මත මොඩල සඳහා OpenAI-අනුකූල එන්ඩ්පොයින්ට් එකත්, රූප සහ වීඩියෝ සඳහා මාධ්‍ය එන්ඩ්පොයින්ට් එකත් භාවිත කරන්න.', standardApi: 'පෙළ, බහුමාධ්‍ය සහ සම්මත API', mediaApi: 'සෘජු රූප සහ වීඩියෝ කාර්ය', workflowTitle: 'සැබෑ වැඩ ප්‍රවාහ සඳහා නිර්මාණය කර ඇත', workflowBody: 'පළමු ඉල්ලීමේ සිට නිෂ්පාදන දෝෂ නිරාකරණය දක්වා භාවිත කළ හැකි ප්‍රවේශ.', modelsTitle: 'මොඩලය මාරු කරන්න, ඒකාබද්ධ කිරීම නොවේ', modelsBody: 'එකම සත්‍යාපනය සහ ඉල්ලීම් ආකෘතිය තබාගෙන නාමාවලියෙන් හැකියාව තෝරන්න.', reliabilityTitle: 'සෑම ඉල්ලීමක්ම නිරීක්ෂණය කළ හැකියි', reliabilityBody: 'තත්ත්වය, මාර්ගය, ප්‍රමාදය සහ භාවිතය එකම වාර්තාවකට සම්බන්ධ වේ.', requestTrace: 'ඉල්ලීම් සටහන', startTitle: 'පළමු ඉල්ලීම යැවීමට සූදානම්ද?', startBody: 'API Key එකක් සාදා, එන්ඩ්පොයින්ට් එක පිටපත් කර OpenAI-අනුකූල SDK එකෙන් අමතන්න.', textModels: 'පෙළ සහ ඒජන්ට්', mediaModels: 'රූප සහ වීඩියෝ', routeLabel: 'මාර්ගය', latencyLabel: 'ප්‍රමාදය', statusLabel: 'තත්ත්වය',
  },
}
