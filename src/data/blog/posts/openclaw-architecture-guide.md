...
> 来源：[LearnPrompt：OpenClaw 架构导读：沿一条消息看懂 Gateway、Node 与 Channel](https://www.learnprompt.pro/agent-frameworks/openclaw-architecture-guide/)。本文为迁移、格式转换和图片路径调整后的整理版，保留原文结构、代码片段与公开教学配图。原站仓库采用 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)；产品版本与事实以原文标注的核验日期为准。
...
![OpenClaw 中 Channel、Operator 与 Node 都经 Gateway 控制平面连接，且 101 至 105 错误架构会被拒绝](/docs/blog/zh/openclaw-architecture-guide/img/openclaw-control-plane-route.svg)
