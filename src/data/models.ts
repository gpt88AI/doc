...
const FEATURED_DETAILS: Record<string, FeaturedDetail> = {
  'gpt-6-astra': {
    provider: 'OpenAI',
    tagline: 'GPT88 当前主推的 GPT-6 Astra，面向复杂推理、编码 Agent 与高价值生产工作流。',
    capabilities: ['GPT-6 Astra', '复杂推理', '代码与工具调用', '结构化输出', '长链路 Agent'],
    scenarios: ['复杂代码任务', '研究分析', '多轮 Agent', '高价值生产任务', '技术方案与审查'],
    overview: [
...
const ENGLISH_MODEL_DETAILS: Partial<Record<string, LocalizedModelDetail>> = {
  'gpt-6-astra': {
    tagline: 'GPT88 featured GPT-6 Astra route for complex reasoning, coding agents, and high-value production workflows.',
    capabilities: ['GPT-6 Astra', 'Complex reasoning', 'Code and tool use', 'Structured output', 'Long-running agents'],
    scenarios: ['Complex coding', 'Research and analysis', 'Multi-step agents', 'High-value production tasks', 'Technical design and review'],
    overview: [
