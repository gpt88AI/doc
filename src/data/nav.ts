...
export const DOCS_NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'OpenAI SDK 接入 GPT88',
        path: '/docs/sdk/openai-sdk/',
        blurb: '只替换 base_url、API Key 和模型名，复用现有 OpenAI SDK 代码',
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'OpenAI 最新模型 GPT-6 Astra',
        path: '/docs/blog/openai-latest-model-gpt-6-astra/',
        blurb: '整理 GPT-6 Astra 的 Responses API、工具调用、提示词策略、迁移参数和 GPT88 排障流程',
      },
      {
        title: 'gpt88 产品与文档地图',
      ...
      },
      {
        ...
        blurb: '异步图片任务的提交、task_id、轮询、结果下载和同步/异步选型说明',
      },
      {
        title: '异步生图 API 详细教程',
        path: '/docs/guides/async-image-generation-guide/',
        blurb: '用 cURL、Node.js、Python 接入异步生图，覆盖任务记录、失败恢复、批量和生产验收',
      },
      {
        title: '生图质量与裁剪避坑',
      ...
      {
        title: 'Codex 办公与知识工作指南',
        path: '/docs/guides/codex-knowledge-work/',
        blurb: '根据 Gorden Sun 文章整理 Codex 的工作空间、五步工作法、工作流模板和 7 天上手计划',
      },
      {
...
const NAV_TITLE_EN_BY_PATH: Record<string, string> = {
  ...
  '/docs/api/grok-video/': 'Grok Video API',
  '/docs/api/list-models/': 'GET /v1/models',
  '/docs/api/errors/': 'Error Codes',
  '/docs/sdk/curl/': 'cURL',
  '/docs/sdk/openai-sdk/': 'OpenAI SDK',
  ...
  '/docs/blog/openai-latest-model-gpt-6-astra/': 'OpenAI Latest Model: GPT-6 Astra',
  ...
  '/docs/guides/agent-job-map/': 'Agent Job Map',
  '/docs/guides/agent-foundations/': 'Agent Foundations',
  '/docs/guides/agent-rag/': 'Agent RAG Engineering',
  '/docs/guides/agent-tools-mcp/': 'Agent Tools & MCP',
  '/docs/guides/agent-production/': 'Agent Evaluation & Production',
  '/docs/guides/agent-interview-project/': 'Agent Interviews & Projects',
  '/docs/guides/kimi-k3-guide/': 'Kimi K3 Guide',
  '/docs/guides/kimi-k3-review/': 'Kimi K3 Review',
  '/docs/guides/grok-4-6-review/': 'Grok 4.6 Review & Comparison',
  '/docs/guides/harness-inspector/': 'Harness Inspector Delivery Guide',
  '/docs/guides/ai-tools/': 'AI Tools Directory',
  ...
  '/docs/guides/async-image-generation-notice/': 'Async Image Generation Notice',
  '/docs/guides/async-image-generation-guide/': 'Async Image Generation Guide',
  ...
  '/docs/guides/codex-knowledge-work/': 'Codex Knowledge Work Guide',
...
const NAV_BLURB_EN_BY_PATH: Record<string, string> = {
  ...
  '/docs/api/grok-video/': 'Grok video generation, task polling, image-to-video parameters, and error handling',
  '/docs/api/list-models/': 'List available models',
  '/docs/api/errors/': 'HTTP and business error code reference',
  '/docs/sdk/curl/': 'Use cURL to validate the API',
  '/docs/sdk/openai-sdk/': 'Reuse an OpenAI SDK by changing the base URL, API key, and model',
  ...
  '/docs/blog/openai-latest-model-gpt-6-astra/': 'GPT-6 Astra capabilities, Responses API migration, tool calling, prompting, unsupported parameters, and GPT88 verification',
  ...
  '/docs/guides/agent-job-map/': 'Map AI Agent job families, capability matrices, and portfolio evidence from real job descriptions',
  '/docs/guides/agent-foundations/': 'Compare Agent, state machine, ReAct, Workflow, Memory, and architecture choices',
  '/docs/guides/agent-rag/': 'Build a RAG workflow from ingestion and retrieval to reranking, citations, evaluation, and updates',
  '/docs/guides/agent-tools-mcp/': 'Design tool calling, MCP, permissions, approvals, failure recovery, and idempotency',
  '/docs/guides/agent-production/': 'Move Agents into production with quality metrics, evaluation sets, traces, cost, capacity, rollout, and rollback',
  '/docs/guides/agent-interview-project/': 'Prepare for Agent interviews with project patterns, live exercises, and a 30-day review plan',
  '/docs/guides/kimi-k3-guide/': 'Configure Kimi K3 with Base URL, Claude Code, and Codex CLI, then troubleshoot socket errors',
  '/docs/guides/kimi-k3-review/': 'Review public benchmarks, real projects, coding ability, stability, and cost for Kimi K3',
  '/docs/guides/grok-4-6-review/': 'Compare public metrics, long-running Agents, cost, and selection boundaries for Grok 4.6 and DeepSeek V4 Pro',
  '/docs/guides/harness-inspector/': 'Connect Agent intent, sessions, file activity, and commits into inspectable delivery evidence',
  ...
  '/docs/guides/async-image-generation-guide/': 'cURL, Node.js, and Python integration for async image generation, task persistence, recovery, batching, and production checks',
  ...
  '/docs/guides/codex-knowledge-work/': 'Structured guide to Codex for office and knowledge work, including workspaces, five-step workflows, templates, review, and a seven-day plan',
...
const SECTION_TITLE_BY_LOCALE: Partial<Record<Locale, Record<string, string>>> = {
  ...
  hi: { 入门: 'शुरुआत', 'SDK 与集成': 'SDK और इंटीग्रेशन', 集成指南: 'इंटीग्रेशन गाइड', 指南: 'गाइड' },
  bn: { 入门: 'শুরু করুন', 'SDK 与集成': 'SDK ও ইন্টিগ্রেশন', 集成指南: 'ইন্টিগ্রেশন গাইড', 指南: 'গাইড' },
  ur: { 入门: 'آغاز', 'SDK 与集成': 'SDK اور انٹیگریشن', 集成指南: 'انٹیگریشن گائیڈز', 指南: 'گائیڈز' },
  ta: { 入门: 'தொடக்கம்', 'SDK 与集成': 'SDK மற்றும் ஒருங்கிணைப்பு', 集成指南: 'ஒருங்கிணைப்பு வழிகாட்டிகள்', 指南: 'வழிகாட்டிகள்' },
  ne: { 入门: 'सुरुवात', 'SDK 与集成': 'SDK र इन्टिग्रेसन', 集成指南: 'इन्टिग्रेसन गाइड', 指南: 'गाइड' },
  si: { 入门: 'ආරම්භය', 'SDK 与集成': 'SDK සහ ඒකාබද්ධ කිරීම', 集成指南: 'ඒකාබද්ධ කිරීමේ මාර්ගෝපදේශ', 指南: 'මාර්ගෝපදේශ' },
}
